...
const About = () => {
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center z-10 space-y-16">
        
        {/* Header */}
        <h2 className="text-sm md:text-base font-light tracking-[0.5em] text-noctiluca-secondary uppercase mb-4 border-b border-noctiluca-primary/20 pb-4 px-12">
          Who We Are
        </h2>
        
        {/* Main Statement */}
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight max-w-4xl tracking-wide">
        ...
        {/* Core Pillars */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 w-full pt-12 border-t border-white/5 mx-auto">
           {[
             ...
             <div key={item.title} className="flex flex-col items-center group cursor-default">
               <h3 className={`text-2xl md:text-3xl font-bold tracking-[0.15em] mb-2 transition-all duration-500 group-hover:scale-110 ${item.color}`}>
                 {item.title}
               </h3>
               <p className="text-gray-500 text-xs tracking-[0.2em] uppercase opacity-60 group-hover:opacity-100 transition-opacity">
                 {item.desc}
               </p>
             </div>
           ))}
        ...
        {/* Secondary Text */}
        <p className="text-sm md:text-base text-gray-400 font-light tracking-widest max-w-2xl text-center leading-relaxed opacity-80">
