...
const Divider = () => {
  return (
    <section id="divider" className="relative w-full  flex flex-col items-center justify-end overflow-hidden  ">
      {/*
        ========================================================================
      ...
      */}
      ...
      <motion.img
        src={lightB}
        alt="Light Horizon A"
        className="absolute  w-full object-cover mix-blend-screen saturate-50 pointer-events-none"
        style={{
