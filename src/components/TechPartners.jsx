...
const TechPartners = () => {
  return (
    <div className="w-full bg-noctiluca-dark py-12 border-b border-white/5 relative overflow-hidden flex flex-col items-center">
      
      <div className="flex flex-col items-center mb-8 space-y-4 z-10">
        <h3 className="text-[10px] md:text-xs tracking-[0.4em] uppercase text-gray-500 font-light">
          OFFICIAL <span className="text-white">DEVELOPMENT PARTNERS</span>
        </h3>
      </div>
