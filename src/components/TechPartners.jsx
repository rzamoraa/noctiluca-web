...
const TechPartners = () => {
  return (
    <div className="w-full bg-noctiluca-dark py-32 border-b border-white/5 relative overflow-hidden flex flex-col items-center">
      {/* Background Ambience */}
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center text-center z-10 px-6">
        ...
        {/* 1. Small Header */}
        <h3 className="text-[10px] md:text-sm tracking-[0.5em] uppercase text-gray-500 font-light mb-16 border-b border-white/10 pb-8">
          OFFICIAL TECHNOLOGY PARTNERS
        </h3>

        {/* 2. Main Statement */}
        <h2 className="text-2xl md:text-5xl font-medium text-white leading-tight tracking-wide mb-12">
        ...
        <p className="text-xs md:text-sm text-gray-400 font-light tracking-widest max-w-3xl leading-relaxed mb-24">
        ...
        {/* 4. Attributes */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 w-full mb-32 max-w-4xl border-t border-white/5 pt-16">
             <div className="flex flex-col items-center">
                <span className="text-noctiluca-primary text-lg md:text-2xl font-bold mb-4">STABILITY</span>
                <span className="text-[10px] tracking-[0.2em] uppercase text-gray-500">Mission Critical Certified</span>
             </div>
             <div className="flex flex-col items-center">
                <span className="text-noctiluca-accent text-lg md:text-2xl font-bold mb-4">INNOVATION</span>
                <span className="text-[10px] tracking-[0.2em] uppercase text-gray-500">Alpha/Beta Access</span>
             </div>
             <div className="flex flex-col items-center">
                <span className="text-white text-lg md:text-2xl font-bold mb-4">PERFORMANCE</span>
        ...
        {/* 6. Logos */}
        <div className="flex flex-wrap justify-center items-center gap-16 md:gap-32 opacity-80 z-10 max-w-5xl mx-auto px-6">
