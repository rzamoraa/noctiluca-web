          ...
          <form onSubmit={handleSubmit} className="w-full space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group">
                <input
                  ...
                  required
                  placeholder="NAME"
                  className="w-full bg-transparent border-b border-white/10 focus:border-noctiluca-accent outline-none py-3 text-white placeholder-gray-600 text-xs tracking-[0.2em] transition-all duration-300"
                />
              </div>
            ...
            <div className="group">
              <textarea
                ...
                rows={4}
                placeholder="MESSAGE"
                className="w-full bg-transparent border-b border-white/10 focus:border-noctiluca-accent outline-none py-3 text-white placeholder-gray-600 text-xs tracking-[0.2em] transition-all duration-300 resize-none"
              ></textarea>
            </div>
